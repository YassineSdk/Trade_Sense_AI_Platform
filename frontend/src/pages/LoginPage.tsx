        ...
        <div className="mx-auto w-full max-w-sm lg:w-96">
          <div>
            <Link to="/" className="flex items-center text-primary-600">
              ...
              <span className="ml-2 text-2xl font-bold">TradeSense AI</span>
            </Link>
          ...
          <div className="mt-8">
            ...
            <div className="mt-6 rounded-lg bg-blue-50 p-4">
              ...
              <div className="mt-2 space-y-1 text-sm text-blue-700">
                <p><strong>Admin:</strong> admin@tradesense.ai / admin123</p>
                <p><strong>User:</strong> user@tradesense.ai / user123</p>
              </div>
            </div>
          ...
          <div className="flex h-full flex-col justify-center px-12 text-white">
            ...
            <ul className="space-y-4 text-lg">
              <li className="flex items-center">
                <svg className="h-6 w-6 mr-3 text-success-300" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              <li className="flex items-center">
                ...
                Get funded and keep 80% profits
              </li>
            </ul>
          </div>
        </div>
